...
// ignore: unused_element
  _MainViewModelData call(
      {RakutenBooksResponse response, MainViewModelState viewModelState}) {
...
mixin _$MainViewModelData {
  RakutenBooksResponse get response;
...
abstract class $MainViewModelDataCopyWith<$Res> {
  ...
  $Res call({RakutenBooksResponse response, MainViewModelState viewModelState});

  $RakutenBooksResponseCopyWith<$Res> get response;
}
...
class _$MainViewModelDataCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      response: response == freezed
          ? _value.response
          : response as RakutenBooksResponse,
  ...
  $RakutenBooksResponseCopyWith<$Res> get response {
    ...
    return $RakutenBooksResponseCopyWith<$Res>(_value.response, (value) {
...
class _$_MainViewModelData implements _MainViewModelData {
  ...
  @override
  final RakutenBooksResponse response;
  @override
